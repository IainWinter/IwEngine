...
namespace ImGui
{
    ...
    // - You are calling ImGui functions after ImGui::EndFrame()/ImGui::RenderAPI() and before the next ImGui::NewFrame(), which is also illegal.
    ...
    // RenderAPI helpers (those functions don't access any ImGui state!)
